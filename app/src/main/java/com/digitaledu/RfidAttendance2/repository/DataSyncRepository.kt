package com.digitaledu.RfidAttendance2.repository

import android.content.Context
import android.util.Log
import com.digitaledu.RfidAttendance2.api.ApiService
import com.digitaledu.RfidAttendance2.db.dao.AppDatabase
import com.digitaledu.RfidAttendance2.db.entity.*
import com.digitaledu.RfidAttendance2.utility.TripleDESUtility
...
class DataSyncRepository(private val context: Context) {
    ...
    suspend fun fetchDeviceDataToServer(
        ...
        val dataParam = (context as? com.digitaledu.RfidAttendance2.view.SelectInstituteActivity)?.getDeviceUtilityQueryParams(context)
            ?: return@withContext false
